# Continuous org-wide GitHub → Forgejo/Codeberg/GitLab mirror with issue and PR metadata sync (`forge-sync`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://forge-sync.sociobot.in`. Artifact class: `cli`.
